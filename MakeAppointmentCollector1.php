...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <?php				
          ...
          $showquery = "SELECT username,address, schedule, timeFrom,timeTo 
          FROM user WHERE materialID = '$selectMID'";
          ...
          //create array to store selected fields data
			    ...
			    if($result-> num_rows > 0){
					...
					'we' => $row['schedule'], 'timeF' => $row['timeFrom'], 'timeT' => $row['timeTo'], 'mId' => $row['$selectMID']);
					}
        }
        ...
        echo'<table width="1000">';
          ...
          foreach($colMaterialArr as $colMaterialArr){
            ...
            echo'<td>'.
            '<form method="POST" action="submission3.php">
            <input type="hidden" name="username" value="'.$colMaterialArr['name'].'"/>
