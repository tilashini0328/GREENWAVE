		...
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">View Submission History</h3>
			...
			<div class="all_user" style="margin-top:0px; margin-left: 40px;">
				<?php 
					...
					$sql = " SELECT * FROM submission INNER JOIN user ON user.username = submission.recycler AND user.totalPoints = submission.pointsAwarded WHERE recycler ='".$_SESSION["username"]."'";
